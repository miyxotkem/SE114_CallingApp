...
import com.example.se114_callingsystem.chat.ChatAdapter;
import com.example.se114_callingsystem.chat.PinnedMessagesAdapter;
import com.example.se114_callingsystem.databinding.FragmentServerChatBinding;
...
public class ServerChatFragment extends Fragment {
    ...
    private static final String TAG = "ServerChatFragment";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            groupName = getArguments().getString("CHAT_NAME");
            serverColor = getArguments().getString("SERVER_COLOR", "#5865F2");
            serverId = getArguments().getString("SERVER_ID");

            if (groupName != null) {
                binding.tvChannelName.setText(groupName.toLowerCase());
                binding.edtMessage.setHint("Message #" + groupName.toLowerCase());
            }
        }
    ...
    private void setupClickListeners() {
        ...
        View.OnClickListener toChatInfo = v -> {
            ...
            args.putString("CHAT_NAME", groupName);
            args.putString("SERVER_ID", serverId);
            args.putString("SERVER_COLOR", serverColor);
            Navigation.findNavController(v).navigate(R.id.action_server_chat_to_chat_info, args);
        };
                ...
                .addOnSuccessListener(doc -> {
                    if (doc.exists() && uid.equals(holder.itemView.getTag()) && getContext() != null) {
                        ...
                        if (profilePic != null && !profilePic.isEmpty()) {
                            Glide.with(ServerChatFragment.this)
                                .load(profilePic)
