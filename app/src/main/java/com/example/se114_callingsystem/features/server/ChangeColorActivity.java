...
public class ChangeColorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_server_change_color);
        ...
        // Láº¥y danh sÃ¡ch cÃ¡c nÃºt mÃ u trong GridLayout
        ...
        updatePreview(selectedColor); // Cáº­p nháº­t mÃ u hiá»‡n táº¡i lÃªn preview
