...
public class PinnedMessagesAdapter extends RecyclerView.Adapter<PinnedMessagesAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_pinned_message, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // 1. Set nội dung tin nhắn dựa trên type
        if ("image".equals(message.getType())) {
            holder.tvMessageContent.setText("📷 Hình ảnh");
            ...
            holder.tvMessageContent.setText("📎 " + fileName);
        } else {
            holder.tvMessageContent.setText(message.getContent());
        }

        // 2. Fetch avatar và tên người gửi từ Firestore
        ...
        if (hasCachedName) {
            ...
            holder.tvSenderName.setText("Đang tải...");
        }
